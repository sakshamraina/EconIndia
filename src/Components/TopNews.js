...
const NewsComponent = () => {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            const response = await fetch('https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=54991fb961714483ab2619fe892315e2');
    ...
    return (
        <div className="news-component" style={{ marginTop: '20vh' }}>
            <Container>
                <h1 className="text-center mb-5">Top Business News</h1>
                <Row>
                    <Col lg={7}>
                        <Card className="mb-3">
